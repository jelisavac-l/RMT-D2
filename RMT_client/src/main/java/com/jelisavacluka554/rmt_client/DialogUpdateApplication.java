...
public class DialogUpdateApplication extends javax.swing.JDialog {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(dateOfEntry.isBefore(now)) {
            JOptionPane.showMessageDialog(null, "Invalid date.", "System", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        if(Integer.parseInt(txtDuration.getText()) > 90) {
            JOptionPane.showMessageDialog(null, "Duration exceeds 90 days.", "System", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        if(lcTable.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Country list is empty.", "System", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void tblCountryMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCountryMouseClicked
        ...
        lcTable.remove(tblCountry.getSelectedRow());
        initTable();
